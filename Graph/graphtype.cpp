...
void GraphType<VertexType>::ModifiedBreadthFirstSearch(VertexType startVertex, VertexType endVertex){
    QueType<VertexType> queue;
    QueType<VertexType> vertexQ;
    StackType<VertexType> vertexS,shortpath;
    bool found = false;
    VertexType vertex, item;
    ClearMarks();
    queue.Enqueue(startVertex);
    ...
    int len=0;
    VertexType temp1,temp2;
    temp1=vertexS.Top();
        vertexS.Pop();
    while(!vertexS.IsEmpty())
    {
        temp2=vertexS.Top();
        if(WeightIs(temp2,temp1)!=1 && !vertexS.IsEmpty())
        {
...
//        cout << temp1 << " ";
        shortpath.Push(temp1);
//            cout << temp1 << "  ";
            len++;
        vertexS.Pop();
        temp1=temp2;
    }
    shortpath.Push(startVertex);
    cout << "Shortest Path : " ;
