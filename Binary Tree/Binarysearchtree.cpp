...
template <class ItemType>
void seekMin(TreeNode<ItemType>* tree)
{
    if (tree != NULL)
    {
        seekMin(tree->left);
...
template <class ItemType>
void TreeType<ItemType>::getMin()
{
    seekMin(root);
}

template <class ItemType>
void seekMax(TreeNode<ItemType>* tree,int& temp)
{
//    while(tree->right!=NULL)
//    {
//        tree=tree->right;
...
//    return  tree->info;
    if (tree != NULL)
    {
        ...
        seekMax(tree->right,temp);
    }
//    if(tree == NULL)
//        return NULL;
//    else if(tree->right== NULL)
//        return tree->info;
//    else return seekMax(tree->right);

}
template <class ItemType>
void TreeType<ItemType>::getMax(int& temp)
{
//    cout << seekMax(root) << endl;
     seekMax(root,temp);
